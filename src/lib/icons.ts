...
export const commonIcons = [
  ...
  "MapPin", "Map", "Globe2", "Earth", "Compass", "Navigation", "Paperclip", "Landmark",
  ...
  "Car", "Truck", "Bus", "Train", "Plane", "Ship", "Rocket", "Helicopter", "Bike", "Scooter",
  "Umbrella", "Crown", "Gem", "Diamond", "Award", "Medal", "Trophy", "Target",
  "Clock", "Timer", "AlarmClock", "Hourglass", "Calendar", "CalendarCheck", "CalendarClock", "DateRange",
  ...
  "Dog", "Cat", "Bird", "Fish", "Butterfly", "Snake", "Turtle",
  ...
  "Save", "DatabaseBackup", "ServerCrash", "Cluster",
  "Network", "ShareNetwork", "Cast", "Wireless", "Bluetooth", "BluetoothConnected",
  ...
  "ExternalLink", "OpenInNew", "Link2", "Link2Off", "Unlink",
  "ToggleLeft", "ToggleRight", "SwitchCamera", "SwitchCamera2",
  "Play", "Pause", "Stop", "SkipBack", "SkipForward", "FastForward", "Rewind", "Volume1",
  "Square", "Circle", "Triangle", "Hexagon", "Octagon", "Pentagon", "Cross",
  "CheckSquare", "SquareStack", "Layers1", "Layers2", "Sprout", "TreeDeciduous",
  "MountainSnow", "Volcano", "Waves", "Droplets", "Drop", "Tint", "Snowflake",
  "Bolt", "Lightning", "SunMedium", "MoonStar",
  "Bible", "Scroll", "BrainCircuit", "Atom", "FlaskConical", "FlaskRound", "Microscope", "TestTube",
  "Dice1", "Dice2", "Dice3", "Dice4", "Dice5", "Dice6",
  "Smile", "Frown", "Meh", "Laugh", "Party", "Confetti", "Gamepad2",
  "Church", "Hospital", "Bank", "Hotel", "Tent",
  "Fence", "DoorOpen", "DoorClosed", "Entrance", "Exit", "Bath", "Bed", "BedDouble",
  "CupSoda", "GlassWater", "Wine", "Whiskey", "IceCream", "Cake",
] as const;
